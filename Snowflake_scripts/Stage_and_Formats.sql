...
CREATE OR REPLACE FILE FORMAT FOOD_DLV.RAW.CSV_FMT
  TYPE = 'CSV'
...
CREATE OR REPLACE STAGE FOOD_DLV.RAW.FOOD_DLV_RAW_STAGE
  STORAGE_INTEGRATION = FOOD_DLV_S3_INT
  URL = 's3://<BUCKET>/raw/'
  FILE_FORMAT = FOOD_DLV.RAW.CSV_FMT;

-- Confirm Snowflake can see your files (should list the seven table folders).
LIST @FOOD_DLV.RAW.FOOD_DLV_RAW_STAGE;